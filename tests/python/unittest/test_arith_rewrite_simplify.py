...
class TestSubIndex(BaseCompare):
    ...
    test_case = tvm.testing.parameter(
        ...
        TestCase((x + 20) - (y + 10), x - y + 10),
        TestCase((x - 20) - (y + 10), x - y - 30),
        TestCase((x + 20) - (y - 10), x - y + 30),
        TestCase((x - 20) - (y - 10), x - y - 10),
        # 4-operands pattern
...
class TestModIndex(BaseCompare):
    ...
    test_case = tvm.testing.parameter(
        ...
        TestCase(tmod(x * (-10) + y, 2), tmod(y - x * 10, 2)),
...
class TestMinIndex(BaseCompare):
    ...
    test_case = tvm.testing.parameter(
        ...
        TestCase(tvm.te.min(tdiv(x, (-10)), tdiv(y, (-10))), 0 - tdiv(tvm.te.max(x, y), 10)),
        # floor div
...
class TestMaxIndex(BaseCompare):
    ...
    test_case = tvm.testing.parameter(
        ...
        TestCase(tvm.te.max(tdiv(x, (-10)), tdiv(y, (-10))), 0 - tdiv(tvm.te.min(x, y), 10)),
